    ...
    <header class="flex items-center mb-6 pb-4">
        <div class="flex justify-between items-end w-full">
            ...
            <div class="flex items-center">
                ...
                <img
                    src="https://gravatar.com/avatar/{{ md5($project->owner->email) }}"
...
{{--                @endforeach--}}
{{--                    <img src="{{ gravatar_url($project->owner->email) }}" alt="{{ $project->owner->name }}'s avatar" class="rounded-b-full w-8 mr-2">--}}

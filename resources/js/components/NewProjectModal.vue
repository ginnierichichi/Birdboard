        ...
        <form @submit.prevent="submit">
            <div class="flex">
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        <label for="title" class="text-sm black mb-2">Title</label>
                        <input
                            type="text"
                            id="title"
                    ...
                    <div class="mb-4">
                        <label for="description" class="text-sm black mb-2">Description</label>
                        <textarea
                            id="description"
                            class="border border-muted-light p-2 text-xs block w-full rounded"
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        <label class="text-sm black mb-2">New Tasks</label>
                        <input
                            type="text"
